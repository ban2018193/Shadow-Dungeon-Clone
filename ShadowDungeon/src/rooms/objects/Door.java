 ...
 * Doors can auto-lock if the stage is not cleared, and takes care of player entry between rooms
 */
public class Door extends Entity {
     ...
     *
     * @param rooms an array of two rooms this door connects. first is Room A, sec is Room B
     * @param startXY positions of the door in each room. first for Room A, sec for Room B
     */
    ...
    /**
     * Auto locks the door if the stage is not cleared and the player has left the door
     *
